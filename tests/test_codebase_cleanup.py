...
class TestObsoleteFileDetector:
    ...
    def test_detect_obsolete_performance_files(self):
        ...
        created_files = self.create_test_files(
            {"obsolete": self.test_files["obsolete"][:4]}
        )
    ...
    def test_detect_build_artifacts(self):
        ...
        created_files = self.create_test_files(
            {"build_artifacts": self.test_files["build_artifacts"]}
        )
    ...
    def test_false_positive_prevention(self):
        ...
        created_files = self.create_test_files(
            {"safe_to_keep": self.test_files["safe_to_keep"]}
        )
        ...
        for category_files in created_files.values():
            for file_path in category_files:
                assert (
                    str(file_path) not in detected_paths
                ), f"Important file {file_path} was incorrectly marked for removal"
    ...
    def test_size_based_filtering(self):
        ...
        detector = ObsoleteFileDetector(
            self.temp_dir, max_file_size_mb=0.001
        )  # 1KB limit
...
class TestCleanupConfig:
    ...
    def test_custom_configuration(self):
        ...
        config_data = {
            ...
            "safety": {"require_confirmation": False, "max_file_size_mb": 100},
        }
    ...
    def test_config_validation(self):
        ...
        invalid_config = {"safety": {"max_file_size_mb": -1}}  # Invalid negative size
...
class TestIntegration:
    ...
    def setup_method(self):
        ...
        self.project_structure = {
            ...
            "source_code": ["src/__init__.py", "src/main.py", "tests/test_main.py"],
        }
