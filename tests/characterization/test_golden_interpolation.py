...
class TestPchipSi:
    ...
    EXPECTED_F2 = np.array(
        [4.60160614, 1.06956209, 0.794992, 0.21351436, 0.05333107]
    )
...
class TestPchipO:
    ...
    EXPECTED_F1 = np.array(
        [6.158406991848629, 8.225556034039512, 8.11077577684706, 8.035817014448238, 8.008253803189419]
    )
    EXPECTED_F2 = np.array(
        [2.58296024588449, 1.754867817295257, 0.09126998399717727, 0.021094965936056333, 0.004490099364666943]
    )
