...
def main():
    ...
    for cmd, description, optional in test_commands:
        ...
        if description == "Integration Tests (without coverage)" and integration_with_coverage_succeeded:
            continue
